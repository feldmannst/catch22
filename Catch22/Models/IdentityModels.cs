...
namespace Catch22.Models
{
    public class RoleStore : IQueryableRoleStore<UserRole, int>
    {
        ...
        public RoleStore(Catch22DataEntities db)
        {
            this.db = db;
        }
        ...
        public Task<UserRole> FindByIdAsync(int Id)
        {
            return this.db.UserRoles.FindAsync(new[] { Id });
        }
        ...
        IUserLockoutStore<User, int>
    {
        ...
        public UserStore(Catch22DataEntities db)
        {
            if (db == null)
            {
        ...
        public Task RemoveClaimAsync(User user, Claim claim)
        {
            ...
            foreach (var item in this.db.UserClaims.Where(uc => uc.Id.Equals(user.Id) && uc.ClaimValue == claim.Value && uc.ClaimType == claim.Type).ToList())
            {
